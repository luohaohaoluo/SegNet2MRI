...
# 预处理输出地址
train_data_path = "../../dataset/brats2020/data"
...
train_ids, val_ids = train_test_split(train_and_test_ids, test_size=0.2, random_state=21)
...
with open('../../dataset/brats2020/train.txt', 'w') as f:
    f.write('\n'.join(train_ids))

with open('../../dataset/brats2020/valid.txt', 'w') as f:
    f.write('\n'.join(val_ids))

# with open('../../dataset/brats2020/test.txt', 'w') as f:
#     f.write('\n'.join(test_ids))
